            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="badges-content">
                        <img src="../assets/images/about/badges-a.png" alt="budges" class="img-fluid">
                        <p>ABC DEF Industry Leader</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="badges-content">
                        <img src="../assets/images/about/badges-b.png" alt="budges" class="img-fluid">
                        <p>Best eCommerce Development Company</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="badges-content">
                        <img src="../assets/images/about/badges-c.png" alt="budges" class="img-fluid">
                        <p>ABC DEF High Performer Winner</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="badges-content">
                        <img src="../assets/images/about/badges-d.png" alt="budges" class="img-fluid">
