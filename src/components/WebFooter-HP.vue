        ...
        <div class="footer-row2">
            <div class="container text-start">
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <h5>Services</h5>
                        <ul class="footer-address-list link-hover" style="
    line-height: 2;">
                    ...
                    <div class="col-lg-3 col-sm-6 footer-blog-">
                        ...
                        <div class="single-blog-">
                            <div class="post-thumb"><a href="https://boxinallsoftech.com/blog/how-to-stay-ahead-of-ai-developments-in-2025/"><img src="../assets/images/blog/AI services (2).jpg"
                                        alt="blog"></a></div>
                            <div class="content">
                                <p class="post-meta"><span class="post-date"><i class="far fa-clock"></i>April 15,
                                        2020</span></p>
                                <h4 class="title"><a href="https://boxinallsoftech.com/blog/how-to-stay-ahead-of-ai-developments-in-2025/">How to Stay Ahead of  &amp; AI Developments in 2025</a></h4>
                            </div>
                        </div>
                        <div class="single-blog-">
                            <div class="post-thumb"><a href="https://boxinallsoftech.com/blog/ai-solutions-companies-driving-business-success-through-technology/"><img src="../assets/images/blog/AI services (1).jpg"
                                        alt="blog"></a></div>
                            <div class="content">
                                <p class="post-meta"><span class="post-date"><i class="far fa-clock"></i>April 15,
                                        2020</span></p>
                                <h4 class="title"><a href="https://boxinallsoftech.com/blog/ai-solutions-companies-driving-business-success-through-technology/">AI Solutions Companies: Driving Business Success &amp; Driving Business Success</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
